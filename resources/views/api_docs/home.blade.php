			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img src="{{asset('image/foto_user/dummy.jpeg')}}" width="38" height="38" class="rounded-circle" alt=""></a>
							</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Main</div> <i class="icon-menu" title="Main"></i></li>
                            <li class="nav-item">
                                <a href="{{route('home.welcome')}}" class="nav-link active">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="" class="nav-link">E-FAB</a></li>
								<li class="nav-item"><a href="{{route('im.api')}}" class="nav-link">INVENTORY MANAGEMENT</a></li>
							</ul>
						</li>
						<!-- <li class="nav-item">
